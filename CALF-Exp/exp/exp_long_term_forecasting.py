            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.visual:
                    if epoch % 5 == 0 and i == 0:
                        torch.save(outputs_dict['attention_weights'], f'./visualization/'
                                                                      f'att_e{epoch}_{self.args.data}.pt')
                        torch.save(outputs_dict['aligned_textual_token'], f'./visualization/'
                                                                          f'aligned_textual_token_e{epoch}_{self.args.data}.pt')
