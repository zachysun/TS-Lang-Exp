...
from utils.cmLoss_Base import cmLoss_base
import torch
...
class Exp_Long_Term_Forecast_Base(Exp_Basic):
    def __init__(self, args):
        super(Exp_Long_Term_Forecast_Base, self).__init__(args)
    ...
    def _select_criterion(self):
        criterion = cmLoss_base(self.args.task_loss,
                                self.args.task_name)
        return criterion
